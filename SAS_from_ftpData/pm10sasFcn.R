...
pm10SASFcn<-function(data,pm10column,dateColumn){ 
  ...
  daysAbove50<-nrow(subset(dt,dt[,2]>=50+0.5))
  
  #calculate daily % of exceedances
  pdaysAbove50<-round((daysAbove50/nd)*100,2)
  ...
  dm %<>% 
    ...
    tidyr::spread(key=date,value=PM10)
