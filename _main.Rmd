...
params:
  preppedData: !r stringr::str_c("./preppedData/",dir('./preppedData')[81],collapse="")
  year: 2021
...
```{r monthlyCapturePlot,fig.width=8,fig.height=13,fig.cap="Hourly data capture by month across the ENV AQHI monitoring network (2009-2020)."}
