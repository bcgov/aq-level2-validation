...
params:
  preppedData: !r stringr::str_c("./preppedData/",dir('./preppedData')[1],collapse="")
  year: 2021
...
**This report is for `r data %>% dplyr::pull(STATION_NAME) %>% unique %>% sort` and includes `r nrow(data)+nrow(prevYrWind)` hours of data**. 
