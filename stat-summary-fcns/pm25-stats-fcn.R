...
# dateColumn<-"DATE_PST"
# data<-readr::read_rds("./prepped-data/Agassiz Centennial Park.rds") |>
#   dplyr::filter(PARAMETER %in% "PM25")
# 
# data %>% distinct(INSTRUMENT)
# 
# pm25_stats_fcn(data) %>% utils::View()

# END TESTING

pm25_stats_fcn<-function(data,pm25column,dateColumn,year){ 
