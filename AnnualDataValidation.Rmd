...
params:
  stations:
    choices: !r readr::read_rds("stations.rds")
    input: select
    label: 'Select stations:'
    multiple: yes
    value: !r c("Kamloops Federal Building","Golden Lady Grey School","Castlegar Zinio Park")
---
...
data<-feather::read_feather("unverifiedData.feather") %>%
  dplyr::filter(STATION_NAME %in% params$stations)
```
...
**Stations selected include: `r stringr::str_c(params$stations,collapse=", ")`.**
