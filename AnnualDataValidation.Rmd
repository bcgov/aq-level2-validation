...
output:
  html_document:
    df_print: paged
params:
  preppedData: "./regionalPreppedData/omineca.rds"
---
...
```{r pm25monthly}
# GOT TO HERE: for omineca this is throwing warnings. need to cycle through stations (line 728) - again.
...
```{r windDataPrep}
# GOT TO HERE, SOMETHING WRONG (REPLACEMENT HAS ONE ROW, DATA HAS 0)
